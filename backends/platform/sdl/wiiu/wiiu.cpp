...
OSystem_Wiiu::OSystem_Wiiu(Common::String baseConfigName)
...
void OSystem_Wiiu::logMessage(LogMessageType::Type type, const char *message) {
	printf("%s\n", message);
}

Common::String OSystem_Wiiu::getDefaultConfigFileName() {
	return _baseConfigName;
}

Common::String OSystem_Wiiu::getDefaultLogFileName() {
	return "scummvm.log";
}
